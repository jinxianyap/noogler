...
export const opportunitiesData = [
    {
        ...
        img: shadow,
        members: 300,
        shortDesc: "An opportunity to shadow Google's CEO for the day, particularly geared toward Googlers in management positions.",
    ...
    },
    {
        ...
        img: mentor,
        members: 500,
        shortDesc: "An opportunity to mentor and inspire a university student who aspires to work in your role.",
        desc: "This is an opportunity to mentor and inspire a university student who aspires to work in your role. This includes taking them through your typical work schedule at Google and letting them know about the benefits available. ",
    },
    {
        name: "Start an initiative",
        img: startInit,
        members: 324,
        shortDesc: "Calling all creative, innovative Googlers! This is an opportunity to start an initiative to improve an aspect of Google.",
    ...
    },
    {
        ...
        img: joinInit,
        members: 435,
        shortDesc: "Calling all creative, innovative Googlers! This is an opportunity to join an initiative that improves an aspect of Google.",
    ...
    },
    {
        ...
        img: volunteer,
        shortDesc: "This is an opportunity to help students and prospective Googlers recognise their ambition and skills at our annual Hackathon event.",
        desc: "This is an opportunity to help students and prospective Googlers recognise their ambition and skills at our annual Hackathon event. This includes a weekend of prizes, presentations and innovation! Judges will be rewarded with inspiration from the new generation of Google!",
    },
    {
        name: "Project Management Certification",
        img: manage,
        shortDesc: "This is an opportunity for Googlers interested in career advancement toward project management.",
        desc: "This is an opportunity for Googlers interested in career advancement toward project management. This qualification features lesson and exams, for which Googlers will have plenty of support. Upon qualification, members are celebrated with a delicious brunch!",
    },
    {
        name: "Google Cloud Developer Certification",
        img: cloud,
        shortDesc: "This qualification is for Googlers interested in career advancement in Google Cloud.",
        desc: "This qualification is for Googlers interested in career advancement in Google Cloud, as well as Googlers who need to refresh their skills in order to adapt to the ever-changing technology climate. All skills and abilities are welcome!",
    },
    {
        name: "Host a Network Event",
        img: host,
        shortDesc: "An opportunity to host one of Google's annual events. Particularly relevant for members of Human Resources.",
